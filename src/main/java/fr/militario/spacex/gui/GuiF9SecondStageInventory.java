...
public class GuiF9SecondStageInventory extends GuiContainerGC {

	private static ResourceLocation rocketTextures = new ResourceLocation(F9Constants.MODID, "textures/gui/falcon9.png");
	private final IInventory upperChestInventory;
	private final EntityF9SecondStage rocket;

	public GuiF9SecondStageInventory(IInventory par1IInventory, EntityF9SecondStage rocket) {
		super(new ContainerF9SecondStage(par1IInventory, rocket));
