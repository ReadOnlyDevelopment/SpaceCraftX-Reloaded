...
public class GuiSchematicFalcon9Rocket extends GuiPositionedContainer implements ISchematicResultPage {
  private static final ResourceLocation rocketBenchTexture = new ResourceLocation(F9Constants.MODID, "textures/gui/falcon9bench.png");
  
  private int pageIndex;
  
  public GuiSchematicFalcon9Rocket(InventoryPlayer par1InventoryPlayer, BlockPos pos) {
    super((Container)new ContainerSchematicFalcon9Rocket(par1InventoryPlayer, pos), pos);
    this.ySize = 221;
  }
  ...
  protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    this.fontRenderer.drawString(SpaceXUtils.translate("schematic.falcon9.name"), 7, 7, 4210752);
