...
public class GuiSchematicSecondStage extends GuiPositionedContainer implements ISchematicResultPage {
  private static final ResourceLocation rocketBenchTexture = new ResourceLocation(F9Constants.MODID, "textures/gui/secondstagebench.png");
  
  private int pageIndex;
  
  public GuiSchematicSecondStage(InventoryPlayer par1InventoryPlayer, BlockPos pos) {
    super((Container)new ContainerSchematicSecondStage(par1InventoryPlayer, pos), pos);
    this.ySize = 221;
  }
  ...
  protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    this.fontRenderer.drawString(SpaceXUtils.translate("schematic.secondstage.name"), 7, 7, 4210752);
