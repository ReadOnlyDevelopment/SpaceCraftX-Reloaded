...
public class GuiOxygenLoader extends GuiContainerGC {
	...
	public GuiOxygenLoader(InventoryPlayer par1InventoryPlayer, TileEntityOxygenLoader par2TileEntityAirDistributor) {
		super(new ContainerOxygenLoader(par1InventoryPlayer, par2TileEntityAirDistributor));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		this.buttonLoadOxygen.enabled = ((this.oxygenLoader.disableCooldown == 0) && (this.oxygenLoader.oxygenTank.getFluid() != null) && ((this.oxygenLoader.oxygenTank.getFluid()).amount != 0));
		this.buttonLoadOxygen.displayString = !this.oxygenLoader.getDisabled(0) ? GCCoreUtil.translate("gui.button.stoploading.name") : SpaceXUtils.translate("gui.button.loadoxygen.name");
	...
	private String getStatus() {
		if ((this.oxygenLoader.oxygenTank.getFluid() == null) || ((this.oxygenLoader.oxygenTank.getFluid()).amount == 0))
			return EnumColor.DARK_RED + SpaceXUtils.translate("gui.status.nooxygen.name");
	...
	public void initGui() {
		...
		this.buttonList.add(this.buttonLoadOxygen = new GuiButton(0, (this.width / 2) + 2, (this.height / 2) - 49, 76, 20, SpaceXUtils.translate("gui.button.loadoxygen.name")));
	}
}
