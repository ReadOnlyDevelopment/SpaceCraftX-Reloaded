...
public class GuiDragonCapsuleInventory extends GuiContainerGC {
	private static ResourceLocation rocketTextures = new ResourceLocation(F9Constants.MODID, "textures/gui/dragon.png");
	private final IInventory upperChestInventory;
	private final EntityDragonCapsule rocket;

	public GuiDragonCapsuleInventory(IInventory par1IInventory, EntityDragonCapsule rocket) {
		super(new ContainerDragonCapsule(par1IInventory, rocket));
	...
	public void initGui() {
		...
		List<String> padSlotDesc = new ArrayList<>();
		padSlotDesc.add(SpaceXUtils.translate("gui.pad_slot.desc.0"));
		...
		this.infoRegions.add(new GuiElementInfoRegion(((this.width - this.xSize) / 2) + 79, ((this.height - this.ySize) / 2) - 1, 18, 18, padSlotDesc, this.width, this.height, this));
	}
}
