...
public class SlotDragonTrunkBench extends Slot {
  ...
  public SlotDragonTrunkBench(IInventory par2IInventory, int par3, int par4, int par5, BlockPos pos, EntityPlayer player) {
  ...
  public boolean isItemValid(ItemStack par1ItemStack) {
    if (par1ItemStack == null)
      return false; 
    List<INasaWorkbenchRecipe> recipes = SpaceXUtils.getDragonTrunkRecipe();
