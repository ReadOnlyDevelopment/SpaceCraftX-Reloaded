...
import fr.militario.spacex.inventory.InventorySecondStageBench;
import fr.militario.spacex.inventory.slots.SlotFalcon9RocketBenchResult;
import fr.militario.spacex.inventory.slots.SlotSecondStageBench;
...
public class ContainerSchematicSecondStage extends Container {
	public static ItemStack findMatchingSpaceshipRecipe(InventorySecondStageBench inventoryRocketBench) {
	...
	public InventorySecondStageBench craftMatrix = new InventorySecondStageBench(this);
	public IInventory craftResult = new InventoryCraftResult();

	private final World worldObj;

	public ContainerSchematicSecondStage(InventoryPlayer par1InventoryPlayer, BlockPos pos) {
		this.slot_limit = 14;
		...
		for (var6 = 0; var6 < 5; var6++) {
			addSlotToContainer(new SlotSecondStageBench(this.craftMatrix, 1 + var6, 39, -6 + (var6 * 18) + 16 + 27, pos, par1InventoryPlayer.player));
		}
		for (var6 = 0; var6 < 5; var6++) {
			addSlotToContainer(new SlotSecondStageBench(this.craftMatrix, 6 + var6, 75, -6 + (var6 * 18) + 16 + 27, pos, par1InventoryPlayer.player));
		}
		addSlotToContainer(new SlotSecondStageBench(this.craftMatrix, 11, 57, 91, pos, par1InventoryPlayer.player));
		addSlotToContainer(new SlotSecondStageBench(this.craftMatrix, 12, 57, 37, pos, par1InventoryPlayer.player));
		addSlotToContainer(new SlotSecondStageBench(this.craftMatrix, 13, 57, 55, pos, par1InventoryPlayer.player));
		addSlotToContainer(new SlotSecondStageBench(this.craftMatrix, 14, 57, 73, pos, par1InventoryPlayer.player));
