...
public class ParticleRocketFlameSmoke extends EntityFXLaunchParticle {
	
	float smokeParticleScale;

	public ParticleRocketFlameSmoke(World par1World, Vector3 position, Vector3 motion, float size) {
		...
		this.particleRed = 40.0F;
		this.particleGreen = 40.0F;
