...
public class DragonTrunkSeparatedItem extends Item implements IHoldableItem, ISortableItem {
	public DragonTrunkSeparatedItem(String assetName) {
		setMaxDamage(0);
		setHasSubtypes(true);
		setMaxStackSize(1);
	...
	public void addInformation(ItemStack par1ItemStack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(SpaceXUtils.translate("gui.message.falcon9.used"));
	}
