...
public class F9SecondStageRocketItem extends Item implements IHoldableItem, ISortableItem {
	public F9SecondStageRocketItem(String assetName) {
		setMaxDamage(0);
		setHasSubtypes(true);
		setMaxStackSize(1);
	...
	public void addInformation(ItemStack par1ItemStack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (par1ItemStack.hasTagCompound() && par1ItemStack.getTagCompound().hasKey("RocketFuel")) {
			EntityF9SecondStage rocket = new EntityF9SecondStage((World) FMLClientHandler.instance().getWorldClient(), 0.0D, 0.0D, 0.0D, IRocketType.EnumRocketType.values()[par1ItemStack.getItemDamage()]);
