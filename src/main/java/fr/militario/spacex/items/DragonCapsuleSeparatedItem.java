...
public class DragonCapsuleSeparatedItem extends Item implements IHoldableItem, ISortableItem {
	public DragonCapsuleSeparatedItem(String assetName) {
		setMaxDamage(0);
		setHasSubtypes(true);
		setMaxStackSize(1);
