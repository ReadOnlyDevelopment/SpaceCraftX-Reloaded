...
public class BlockOxygenLoader extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public BlockOxygenLoader(String assetName) {
		super(Material.ROCK);
		setHardness(1.0F);
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityOxygenLoader();
	}
