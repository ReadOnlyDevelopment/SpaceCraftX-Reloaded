...
public class BlockFuelUnloader extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public BlockFuelUnloader(String assetName) {
		super(Material.ROCK);
		setHardness(1.0F);
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityFuelUnloader();
	}
