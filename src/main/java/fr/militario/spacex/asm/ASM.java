package fr.militario.spacex.asm;
...
public class ASM {
	...
	public static <T> Constructor<T> getConstructor(Class<T> clazz, Class<?>... types) {
		try {
			...
			SpaceX.logger.error("Exception getting constructor of " + clazz.getName(), ex);
		}
		return null;
	}
	...
	public static Constructor<?> getConstructor(final String className, final Class<?>... argumentTypes) {
		if ((className == null) || (argumentTypes == null)) {
			SpaceX.logger.error("The provided class name or arguments can't be null.");
			return null;
		}
		try {
			...
			SpaceX.logger.error("Exception getting constructor of " + className, ex);
		}
		return null;
	}
	...
	public static <T> T getFinalObject(Object object, String... fieldNames) {
		...
		for (String field : fieldNames) {
			try {
				...
				SpaceX.logger.error("Exception in getFinalObject()", ex);
			}
		}
		SpaceX.logger.error("Could not retrieve any final object for the provided field names.");
	...
	public static <T> T getInstance(Constructor<T> constructor, Object... arguments) {
		try {
			...
			SpaceX.logger.error("Exception creating instance of " + constructor.getClass().getName(), e);
		}
		return null;
	}
	...
	public static <T> T getObject(Object object, String... fieldNames) {
		...
		for (String field : fieldNames) {
			try {
				...
				SpaceX.logger.error("Exception in getObject()", ex);
			}
		}
		SpaceX.logger.error("Could not retrieve any object for the provided field names.");
	...
	public static <T> T getStaticObject(Class<?> clazz, String... fieldNames) {
		for (String field : fieldNames) {
			try {
				...
				SpaceX.logger.error("Exception in getStaticObject()", e);
			}
		}
		SpaceX.logger.error("Could not retrieve any static object for the provided field names.");
