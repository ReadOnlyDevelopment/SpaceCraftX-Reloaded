...
public class RenderF9SecondStage extends Render<EntityF9SecondStage> {
	...
	public RenderF9SecondStage(RenderManager manager, ModelBase spaceshipModel, String textureDomain, String texture) {
	...
	private RenderF9SecondStage(RenderManager manager, ResourceLocation texture, ResourceLocation texture_used) {
		super(manager);
	...
	@Override
	public void doRender(EntityF9SecondStage entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityF9SecondStage entity) {
		if ((entity.launchPhase == EntitySpaceshipBase.EnumLaunchPhase.LANDING.ordinal()) || ((entity.launchPhase == EntitySpaceshipBase.EnumLaunchPhase.UNIGNITED.ordinal()) && entity.getStagesSeparated()))
			return this.spaceship_usedTexture;
		return this.spaceshipTexture;
	}

	@Override
	public boolean shouldRender(EntityF9SecondStage rocket, ICamera camera, double camX, double camY, double camZ) {
