...
public class RenderDragon extends Render<EntityDragonCapsule> {
	...
	public RenderDragon(RenderManager manager, ModelBase spaceshipModel, String textureDomain, String texture) {
	...
	private RenderDragon(RenderManager manager, ResourceLocation texture, ResourceLocation texture_used) {
		super(manager);
	...
	@Override
	public void doRender(EntityDragonCapsule entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityDragonCapsule entity) {
		if (entity.getHasFlyed())
			return this.spaceship_usedTexture;
		return this.spaceshipTexture;
	}

	@Override
	public boolean shouldRender(EntityDragonCapsule rocket, ICamera camera, double camX, double camY, double camZ) {
